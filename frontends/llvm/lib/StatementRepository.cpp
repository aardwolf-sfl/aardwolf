...
void StatementRepository::registerStatement(llvm::Function *F, Statement& Stmt) {
    getStatementId(Stmt);
...
void StatementRepository::addSuccessor(llvm::Instruction* Stmt, llvm::Instruction* Succ) {
