...
bool ExecutionTrace::runOnFunction(llvm::Function &F) {
    ...
    for (auto I : Repo.FuncMap[&F]) {
        std::vector<llvm::Value*> Args;
            ...
            Args.push_back(llvm::ConstantInt::get(StatementRefTy, Repo.getStatementId(Repo.StmtMap[I])));
...
static llvm::RegisterPass<ExecutionTrace> X("aard-exec-trace", "Aardwolf Execution Trace Pass");
